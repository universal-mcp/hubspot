...
You can start using Hubspot directly from [agentr.dev](https://agentr.dev). Visit [agentr.dev/apps](https://agentr.dev/apps) and enable Hubspot.
...
The full list of available tools is at [./src/universal_mcp_hubspot/README.md](./src/universal_mcp_hubspot/README.md)
...
3. **Start the MCP Inspector**
   ...
   ```bash
   mcp dev src/universal_mcp_hubspot/server.py
   ```
...
4. **Install the Application**
   ```bash
   mcp install src/universal_mcp_hubspot/server.py
   ```
